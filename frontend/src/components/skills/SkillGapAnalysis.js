...
const SkillGapAnalysis = () => {
  ...
  const handleShowSkillResources = (skillName) => {
    console.log('Resources button clicked for skill:', skillName);
    console.log('Current selectedSkill:', selectedSkill);
    setSelectedSkill(skillName === selectedSkill ? null : skillName);
    console.log('New selectedSkill will be:', skillName === selectedSkill ? null : skillName);
  };
                ...
                {selectedSkill === skill.skillName && (
                  <div className="resource-container">
                    <div className="resource-header">
                      <h5>Learning Resources for {skill.skillName}</h5>
                      <button 
                    ...
                    {SkillResources ? (
                      <SkillResources 
                        ...
                        isVisible={selectedSkill === skill.skillName}
                        onToggle={() => setSelectedSkill(null)}
                      />
                    ) : (
                      <div className="resources-fallback">
                        <p>Resources component not available</p>
                        <p>Loading resources for {skill.skillName}...</p>
                      </div>
                    )}
                  </div>
                )}
